...
onMounted(() => {
  const welcomeTextChildren = welcomeText.value.children;
  setTimeout(() => {
    [...welcomeTextChildren].forEach(el => {
...
<template>
  <div
    class="flex flex-col items-center justify-center min-h-screen gap-2 capitalize font-serif"
    ref="welcomeText"
  >
    <div
